...
if (!preg_match("/^[0-9]+$/", $idDomaine) && $idDomaine !== '*') {
    ReponseJson::envoyerLesErreurs(['global' => "L'identifiant du domaine n'est pas valide."], 400);
}

// envoi de la réponse
ReponseJson::envoyerLesDonnees(Competence::getLesCompetences($idBloc, $idDomaine));
