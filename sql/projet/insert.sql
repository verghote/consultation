...
values (1, 1, 1, 'Recenser et identifier les ressources numériques'),
       ...
       (2, 3, 2,
        'Développer des fonctionnalités applicatives au sein d''un système de consultation de base de données (relationnel ou non)'),
...
values (1, 'Gestion des grands prix de formule 1'),
